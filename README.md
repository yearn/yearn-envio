...
The [Vault Allocation History producer](allocation/README.md) is part of this Envio project. Its entities are additive to the root schema, its handlers run only for Ethereum, and archive-RPC failures are recorded without stopping unrelated indexing.
